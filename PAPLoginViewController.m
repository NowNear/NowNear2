...
- (IBAction)login:(id)sender
{
    ...
    [query getFirstObjectInBackgroundWithBlock:^(PFObject *object, NSError *error) {
        if (!object) {
            ...
            UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"NowNear" message:@"Invalid credentials" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
            [alertView show];
            return;
        }
...
- (void)resetPassword:(NSString *)recoveryEmail isUpperCase:(BOOL)isUpperCase
{
    ...
    [PFUser requestPasswordResetForEmailInBackground:recoveryEmail block:^(BOOL succeeded, NSError *error) {
        if (succeeded) {
            UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"NowNear" message:@"Instruction mail sent. Please check your mail box" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
            [alertView show];
        }
        else {
