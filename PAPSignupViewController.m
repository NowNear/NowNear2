...
- (IBAction)signup:(id)sender
{
    if ([username.text isEqualToString:@""] || [password.text isEqualToString:@""] || [email.text isEqualToString:@""]) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"NowNear" message:@"Please fill in all the fields" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alert show];
        return;
    }
    if (![password.text isEqualToString:confirmPwd.text]) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"NowNear" message:@"Sorry please double check your password/email" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alert show];
        return;
    }
    ...
    if (!hasValidProfilePic) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"NowNear" message:@"Please add a profile photo." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alert show];
        return;
    }
...
//        }
    ...
    [user signUpInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
        if (!error) {
            ...
            UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"NowNear" message:[[error userInfo] objectForKey:@"error"] delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
            [alertView show];
        }
