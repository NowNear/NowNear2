...
#if DEBUG
NSString * const parseApplicationId = @"uuASb6z5tcFCWHCAWwjwqNfpnDyuuaBw0ZAAQ58n"; // Test environment
NSString * const parseClientKey = @"W66KrsD2PLNGNfS1sHUvZlWVnkVLktNLDb0UiL22";
//NSString * const parseApplicationId = @"eKct7UNWimlGuF9NJZnDJukcRwNvEQWbN3e5Z9Kr"; // Test environment
//NSString * const parseClientKey = @"h7mkqKDiOtaWmqiJEPU8kcrcDJSHGo6SBZIxlRJ4";
#else
...
- (void)presentTabBarController {
    ...
    [self.navController setViewControllers:@[ self.splashViewController, self.tabBarController ] animated:YES];
