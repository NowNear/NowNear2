...
@property (nonatomic, weak) IBOutlet IQDropDownTextField * brandTextField;
...
- (void)doneButtonAction:(id)sender {
   ...
   // PFObject *photo4 = [PFObject objectWithClassName:kPAPPhotoClassKey];
    ...
    [photo setObject:trimmedTitle forKey:kPAPPhotoDescriptionKey];
    [photo setObject:trimmedBrand forKey:kRLBrandKey];
    [photo setObject:trimmedDescription forKey:kPAPPhotoTitleKey];
